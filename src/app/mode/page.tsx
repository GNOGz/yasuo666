    ...
    >
      <div className="text-outline text-center text-9xl">
        ...
        <div className="flex flex-col gap-10">
          <div onClick={handleDuelClick} className="cursor-pointer hover:scale-110">{`Duel`}</div>
          <div className="cursor-pointer hover:scale-110">{`Solitare`}</div>
          <div className="cursor-pointer hover:scale-110">{`Auto`}</div>
        </div>
      </div>

      <div className="absolute bottom-5 right-5 text-8xl text-outline">
        <div onClick={handleBackClick} className="cursor-pointer hover:scale-110">{`Back`}</div>
      </div>
    </div>
  );
};
